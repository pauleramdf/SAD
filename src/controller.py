...
class Controller:
    ...
    def salvarSolucao1(self):
        self.model.salvarSolucao1()

    def salvarSolucao2(self):
        self.model.salvarSolucao2()
    
    def carregarSolucao1(self):
        self.tabela.updateTabela(self.model.carregarSolucao1())
        
    def carregarSolucao2(self):
        self.tabela.updateTabela(self.model.carregarSolucao2())#self.model.exibeSolucao((self.model.otimizacao))
